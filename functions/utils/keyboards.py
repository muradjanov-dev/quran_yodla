...
def reciter_keyboard(for_memorize: bool = True) -> InlineKeyboardMarkup:
    reciters = (
        ["husary", "afasy", "ghamdi", "sudais", "minshawi"]
        if for_memorize
        else ["abdulbasit", "afasy", "muaiqly", "matrood", "husary", "ghamdi", "sudais", "shatri"]
    )
...
def accumulation_keyboard(ayah_count: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[
        InlineKeyboardButton(
            f"✅ {ayah_count} oyatni 7 marta o'qidim",
